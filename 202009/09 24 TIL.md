...
var DATA = [
  { user: 'ingikim', message: 'Welcome to Code States #codestates', created_at: '2019-01-05 07:30:20' },
  ...
  { user: 'tim', message: 'education for real world', created_at: '2015-01-03 12:30:20' },
];
...
Date.prototype.format = function(format) {
  ...
  var format = `${yyyy}-${month}-${dd} ${HH}:${mm}:${ss}`;
  return format;
}
